...
- Duplicate features were not analyzed in depth in this work, leaving it unclear how many of the extracted features are fully unique. Future research could involve analyzing the cosine similarities between features, which would offer more insights into their similarity and uniqueness. This analysis could also help explain why different features produce nearly identical average board state plots. For instance, this similarity might be due to a phenomenon like [feature splitting](#https://www.lesswrong.com/posts/baJyjpktzmcmRfosq/stitching-saes-of-different-sizes#:~:text=We%20show%20that%20features%20in%20larger%20SAEs%20cluster%20into%20two%20kinds%20of%20features%3A%20those%20that%20capture%20similar%20information%20to%20the%20smaller%20SAE%20(either%20identical%20features%2C%20or%20split%20features%3B%20about%2065%25)%2C%20and%20those%20which%20capture%20novel%20features%20absent%20in%20the%20smaller%20mode%20(the%20remaining%2035%25).).


- It is unclear how these results generalize to architectural changes in Othello-GPT. Future work could explore the architectural influences on both Othello-GPT and SAEs. For instance, investigating how the size of the residual stream affects the number and complexity of features extracted by SAEs with comparable expansion factors could be enlightening.
