...
- Duplicate features were not analyzed in depth in this work, making it unclear how many of the extracted features are fully unique. In future research, the cosine similarities between features could be analyzed, providing more valuable insights into the similarity and uniqueness of the features, and potentially explaining why different features produce nearly identical average board state plots.
